            ...
            <form action="code.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal_peminjaman" class="form-control" placeholder="Enter Lokasi Awal">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Jangka Peminjaman</label>
                        <input type="text" name="jangka_peminjaman" class="form-control" placeholder="Enter Jangka Peminjaman">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Tanggal Pengembalian</label>
                        <input type="date" name="tanggal_pengembalian" class="form-control" placeholder="Enter Tanggal Pengembalian">
                    </div>
                        ...
                        if(mysqli_num_rows($query_run) > 0)
                        {
                          while($row = mysqli_fetch_assoc($query_run))
                          {
                            ...
                            <tr>
                              ...
                              <td><?php echo $row['jangka_peminjaman']; ?></td>
